    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            @if ($logged_in_user->isAdmin())
                ...
                <li class="nav-item">
                    <a class="nav-link {{
                        active_class(Route::is('admin/specialists'))
                    }}" href="{{route('admin.specialists.index')}}">
                        <i class="nav-icon fas fa-hospital-o"></i>
                        @lang('menus.backend.sidebar.specialists')
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link {{
                        active_class(Route::is('admin/analysis'))
                    }}" href="{{route('admin.analysis.index')}}">
                        <i class="nav-icon fas fa-flask"></i>
                        @lang('menus.backend.sidebar.analysis')
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link {{
                        active_class(Route::is('admin/reservations'))
                    }}" href="{{route('admin.reservations.index')}}">
                        <i class="nav-icon fa fa-ticket"></i>
                        @lang('menus.backend.sidebar.reservations')
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link {{
                        active_class(Route::is('admin/profiles'))
                ...
                <li class="nav-item">
                    <a class="nav-link {{
                        active_class(Route::is('admin/financial'))
                    }}" href="#">
                        <i class="nav-icon fa fa-money"></i>
                        @lang('menus.backend.sidebar.financial')
                    </a>
                </li>
